...
function ToptalBadge() {
  return (
    <div style={{ display: 'inline-block', background: '#25a9ef', padding: '4px', clipPath: HEX }}>
      <div
        style={{
          width: '115px',
          padding: '16px 0 24px',
      ...
      >
        <svg width={38} viewBox="0 0 60 17" xmlns="http://www.w3.org/2000/svg">
        ...
        <p style={{ margin: 0, fontSize: '11px', fontWeight: 700, lineHeight: 1 }}>TOP 3% TALENT</p>
        <div style={{ width: '70px', height: '1px', background: '#25a9ef' }} />
        <span style={{ fontSize: '9px', marginBottom: '-3px' }}>Vetted by</span>
        <svg style={{ width: '60px' }} viewBox="0 0 108 30" xmlns="http://www.w3.org/2000/svg">
